...
func (a *App) drawMenuBackground(screen *ebiten.Image) {
	vector.DrawFilledRect(screen, 0, 0, screenW, screenH, color.RGBA{12, 18, 27, 255}, false)
	vector.DrawFilledRect(screen, 0, 84, screenW, screenH-156, color.RGBA{15, 23, 34, 255}, false)
